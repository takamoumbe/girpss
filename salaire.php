...
<html lang="en">
    <head>
        ...
        <!-- App title -->
        <title>Salaire enseignants</title>
                            ...
                            <ul class="nav navbar-right">
                                ...
                                <li class="dropdown user-box">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right arrow-dropdown-menu arrow-menu-right user-list notify-list">
                                        ...
                                        <li><a href="index.php" class="dropdown-item"><i class="ti-power-off m-r-5"></i> Deconnexion</a></li>
                                    </ul>
                                </li>
                        ...
                        <div class="row">
							<div class="col-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Payer les salaires </h4>
                                    <div class="clearfix"></div>
                                </div>
							</div>
						</div>
                                ...
                                <div class="card-box widget-box-two widget-two-primary row col-md-12">
                                  <div class="col-md-7">
                                    <p class="text-uppercase font-600 font-secondary text-overflow">Mr KANGA</p>
                                      <h5 class="">Maths</h5>
                                      <p>04/01/2022</p>
                                      <h6 class="text-danger">7000 XAF</h6>
                                  </div>
                                  <div class=" col-md-5">
