...
<html lang="en">
    <head>
        ...
        <!-- App title -->
        <title>Renitialiser votre mot de passe</title>
    ...
    <body class="bg-transparent">
                            ...
                            <div class="m-t-40 account-pages">
                                ...
                                <div class="account-content">
                                    <div class="text-center m-b-20">
                                        <p class="text-muted m-b-0 font-13">Entrer votre email et suivez les instructions pour renitialiser votre mot de passe.  </p>
                                    </div>
                                        ...
                                        <div class="form-group account-btn text-center m-t-10 row">
                                            <div class="col-12">
                                                <button class="btn w-md btn-bordered btn-danger waves-effect waves-light"
                                                        type="submit" name="recuperer_pass">Envoyer
                                                </button>
                                            </div>
                                        </div>
        ...
        <script src="assets/js/jquery.app.js"></script>
          ...
          <?php if (isset($_SESSION['message_recuperer_pass'])):?>
      <?php
        echo '<script type="text/javascript">';
        echo 'alert("';
        echo $_SESSION['message_recuperer_pass'];
        echo '")';
        echo "</script>";
        unset($_SESSION['message_recuperer_pass']);
     ?>
    <?php  endif ?>
    </body>
</html>
